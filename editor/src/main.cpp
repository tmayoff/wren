...
void Scene::on_update() {
  ...
  // ImGuiDockNodeFlags_None; ImGuiWindowFlags window_flags =
  ...
  //         dockspace_id, ImGuiDir_Down, 0.25, nullptr,
  //         &dockspace_id);
  ...
  //         dockspace_id, ImGuiDir_Left, 0.25F, nullptr,
  //         &dockspace_id);

  //     ImGui::DockBuilderDockWindow("Inspector",
  //     dockspace_id_right); ImGui::DockBuilderDockWindow("Viewer",
  //     dockspace_id); ImGui::DockBuilderDockWindow("Scene",
  //     dockspace_id_left);
  //     ImGui::DockBuilderDockWindow("Filesystem",
  //     dockspace_id_bottom);
  ...
  // ImGui::PushStyleVar(ImGuiStyleVar_WindowMinSize, ImVec2{500,
  // 100}); ImGui::Begin("Scene"); ImGui::End();
